...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; cha5rset=UTF-8">
...
<body>
			...
			<div class="telInfo">
				...
				<div class="detail">
					...
					<a
						...
						href="login.jsp" target="myframe">登录</a> <a
						style="font-size: 18px; float: right; margin-right: 15px; margin-top: 5px; color: #917739;"
						href="regis.jsp" target="myframe">注册</a> <br>4000-999-158
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<ul class="topNav">
					...
					<li><a class="item" href="http://www.ying158.com/home/kcenter">
							网上体验中心 </a></li>
					<li class="item"><a class="item" href="<%=basePath %>indexlist" target="myframe">
							产品中心 </a></li>
					<li><a class="item"
	...
	<!-- 中间开始 -->
		...
		<link href="<%=basePath%>resources/web/images/icon.ico"
			type="image/x-icon" rel="shortcut icon">
		<div>
			<iframe src="<%=basePath%>indexlist" scrolling="no" width="1830px;" height="1100px;" name="myframe"></iframe>
		</div>
